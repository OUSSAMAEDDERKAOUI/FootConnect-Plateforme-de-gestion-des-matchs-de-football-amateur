...
<head>
    ...
    <title>FootConnect - Medecin @yield('title') </title>
        ...
        <aside class="sidebar-mobile fixed md:relative z-30 w-64 bg-blue-800 text-white h-full md:transform-none md:block" id="sidebar">
            <div class="p-4">
                ...
                <nav class="space-y-2">
                    ...
                    <a href="/medecin/blessures"
                        class="block py-2.5 px-4 rounded transition duration-200 hover:bg-blue-700 active bg-blue-700"
                        id="Blessures">
                       Les Blessures
                    </a>
                    <a href="/medecin/matchs" class="block py-2.5 px-4 rounded transition duration-200 hover:bg-blue-700"
                        id="matchesTab">
                        Matchs
                    </a>
                    <a href="/medecin/liste/joueurs"
                    class="block py-2.5 px-4 rounded transition duration-200 hover:bg-blue-700  bg-blue-700"
                    id="playerListsTab">
                    Listes des Joueurs
                </a>
                <a href="/medecin/sanctions" class="block py-2.5 px-4 rounded transition duration-200 hover:bg-blue-700"
                        id="sanctionsTab">
                        Sanctions
                    </a>
