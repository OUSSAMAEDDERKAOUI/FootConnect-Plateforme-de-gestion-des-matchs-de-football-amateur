        ...
        <div class="bg-white rounded-lg shadow p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p id="carte_rouge" class="text-2xl font-semibold">2</p>
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p id="carte_jaune" class="text-2xl font-semibold">3</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p id="Avertissements" class="text-2xl font-semibold">8</p>
                </div>
            </div>
        </div>
    </div>
...
<script src='{{asset("js/adminLigue/sanctions.js")}}'> </script>
