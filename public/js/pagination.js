...
window.renderSimplePagination = (paginationData, loadFunction, tableSelector = 'table', paginationId = 'simple-pagination') => {
    // Cibler la table spécifique
    const table = document.querySelector(tableSelector);
    
    // Chercher un conteneur de pagination spécifique à cette table
